...
export default function ProjectFooter(props) {
  return (
    <Link className={`${styles.footer} no-underline footer block overflow-hidden h-48`} href={`/projects/${props.url}`}>
      <div className='relative flex justify-center align-middle h-48 overflow-hidden'  style={{backgroundColor: props.backgroundColor}} >
        ...
        <div className='absolute w-full h-12 bg-gradient-to-b from-neutral-900 opacity-75 z-[3]'></div>
